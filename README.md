...
GET xem info của GV
    ...
    PUT update info gv: params {first_name_lecturer,last_name_lecturer,date_of_birth,phone_number_lecturer,email}

---

lecturer/subject-class
GET Lấy tất cả những Lớp GV đang dạy. Mảng 2 chiều
...
POST tạo thông báo params{type,title,description}
